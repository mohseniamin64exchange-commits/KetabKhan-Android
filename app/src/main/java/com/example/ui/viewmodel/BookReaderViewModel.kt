...
class BookReaderViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun updateReaderSettings(update: ReaderSettings.() -> ReaderSettings) {
        _readerSettings.value = _readerSettings.value.update()
    }
    ...
    // Conversion Process Simulation & Real handling
    fun startConversion() {
    ...
    fun resolveCurrentIssue(action: String) { // "confirm", "edit", "ignore"
